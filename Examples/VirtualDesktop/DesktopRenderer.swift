...
struct DesktopSurfaceGeometry {
    ...
    /// Stage-2 plumbing: map a quad hit expressed as top-left-origin UV into
    /// captured desktop pixels. The returned coordinate is clamped to the image.
...
final class DesktopRenderer {
    ...
    init(
        ...
        pipelineDescriptor.label = "SwiftXR virtual desktop pipeline"
        ...
        samplerDescriptor.label = "SwiftXR virtual desktop sampler"
        ...
        guard let buffer else {
            throw DesktopRendererError.bufferCreationFailed
        }
        buffer.label = "SwiftXR virtual desktop vertices"
    ...
    func encode(
        ...
        for eye in 0..<2 {
            ...
            encoder.label = eye == 0
                ? "SwiftXR desktop left eye"
                : "SwiftXR desktop right eye"
            encoder.setViewport(
                MTLViewport(
                    originX: 0,
                    originY: 0,
